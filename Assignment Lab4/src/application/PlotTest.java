...
public class PlotTest {
	...
	public void testEncompasses1() {
		assertFalse(plot1.encompasses(plot5)); //plot5 is contained in plot1
		assertFalse(plot5.encompasses(plot1));
		assertFalse(plot1.encompasses(plot11)); //plot11 is contained in plot1
		assertFalse(plot11.encompasses(plot1));
		assertFalse(plot1.encompasses(plot12)); //plot12 is contained in plot1
